...
/**
 * Protobuf type {@code proto.MortgageStocksRequest}
 */
public  final class MortgageStocksRequest extends
    com.google.protobuf.GeneratedMessageLite<
            MortgageStocksRequest, MortgageStocksRequest.Builder> implements
    // @@protoc_insertion_point(message_implements:proto.MortgageStocksRequest)
  ...
  public static MortgageStocksRequest parseFrom(
  ...
  public static MortgageStocksRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static MortgageStocksRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
  ...
  public static MortgageStocksRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static MortgageStocksRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(MortgageStocksRequest prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
              MortgageStocksRequest, Builder> implements
      // @@protoc_insertion_point(builder_implements:proto.MortgageStocksRequest)
          MortgageStocksRequestOrBuilder {
    // Construct using dalalstreet.api.actions.MortgageStocksRequest.newBuilder()
    private Builder() {
    ...
    // @@protoc_insertion_point(builder_scope:proto.MortgageStocksRequest)
  }
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new MortgageStocksRequest();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        MortgageStocksRequest other = (MortgageStocksRequest) arg1;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (MortgageStocksRequest.class) {
            if (PARSER == null) {
  ...
  // @@protoc_insertion_point(class_scope:proto.MortgageStocksRequest)
  private static final MortgageStocksRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new MortgageStocksRequest();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static MortgageStocksRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
